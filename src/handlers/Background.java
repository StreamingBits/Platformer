...
public class Background {
	...
	public void render(SpriteBatch sb) {
		...
		float x = ((this.x + gameCam.viewportWidth / 6 - gameCam.position.x) * scale) % image.getRegionWidth();
		float y = ((this.y + gameCam.viewportHeight / 6- gameCam.position.y) * scale) % image.getRegionHeight();
